...
# Put your strategy names between brackets in line below. Strategy separate with space or newline. You can add all Your strategies from gekko/strategies directory with adding line ALL.
@strategies = qw(
MACD
CCI
RSI
...
$from = '2021-04-26 15:00:00';
$to = '2021-04-30 08:00:00';
